...
{
    public static void SpawnSmallExplosion(FlipnoteStudioColors.ColorID id, Vector2 position, float duration = 0.15f)
    {
        Color col = FlipnoteStudioColors.GetColor(id);
    ...
    public static void SpawnMediumExplosion(FlipnoteStudioColors.ColorID id, Vector2 position, float duration = 0.25f)
    {
        Color col = FlipnoteStudioColors.GetColor(id);
    ...
    public static void SpawnBigExplosion(FlipnoteStudioColors.ColorID id, Vector2 position, float duration = .4f)
    {
        Color col = FlipnoteStudioColors.GetColor(id);
